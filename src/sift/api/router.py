...
from sift.api.routes.discovery import router as discovery_router
...
from sift.api.routes.navigation import router as navigation_router
from sift.api.routes.plugins import router as plugins_router
